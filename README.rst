...
.. |commits-since| image:: https://img.shields.io/github/commits-since/open-source-botany/growlog/v0.4.2.svg
    :alt: Commits since latest release
    :target: https://github.com/open-source-botany/growlog/compare/v0.4.2...master
